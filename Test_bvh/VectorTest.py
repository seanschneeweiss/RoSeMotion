...
p1_rot = np.array([70.5982055664, 150.242660522, 106.237617493])
p2_rot = np.array([53.6911888123, 168.412765503, 84.4688644409])
p3_rot = np.array([31.4088935852, 168.953857422, 24.6387023926])

vec1 = p2_rot - p1_rot
vec2 = p3_rot - p2_rot


quaternions = vec2quat(vec1, vec2)
print(quaternions)
rotm = quat_to_mat(quaternions)
print(rotm)
euler = rot2eul(rotm)
print(euler)